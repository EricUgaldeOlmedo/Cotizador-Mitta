<?php include("../modelo/listacotizacion_adm.php"); ?>
  <?php include("../modelo/select/lista_empresa.php"); ?>
  <?php include("../modelo/select/lista_marca.php"); ?>

<!--    GENERAR UN MODELO LISTARUSUARIO.PHP DESDE HAY PASAAR POR PARAMETRO EL USARIO. LUEGO REALIZAR UN LISTADO EN ESTA PAGINA CON UN FOREACH Y DESDE ES LISTADO ENTREGAR EL PARAMETRO DEL NOMBRE DEL COORDINADOR A UN IMPUT. -->
...
<form  action="" method="POST" >
        <td><div align="center">
          <input type="text" hidden name="idcotizacion" value="<?php echo $n->idcotizacion?>" style="width:1px;height:1px">     
          <button disabled="" id="show" style="font-size: 30px"><i class="far fa-edit"></i></button>       
        </div>
...
<form  action="../modelo/enviarcotizacion_adm.php"  method="POST" id="formulario">
        <td><div align="center">
...
<form  action="../modelo/eliminarcotizacion_adm.php" method="GET" >
        <td><div align="center">
          <input type="text" hidden name="idcotizacion" value="<?php echo $n->idcotizacion?>" style="width:1px;height:1px">      
...
<div id="element" style="display: block;">
 <?php include("modificar_cotizacion_adm.php"); ?>
</div>
