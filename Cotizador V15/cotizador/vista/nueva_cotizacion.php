...
<form class="w3-container" action="../modelo/nuevacotizacion.php" method="post">

<br>
<div align="left" class="w3-container w3-black" style="width:1000px;height:35px">Datos</div>
...
<!--   <div><td><input readonly  type="hidden" value="2" name="ejecutivo"></td></div>
  <div><td><input readonly  type="hidden" value="0" name="valor"></td></div>
 -->
...
<td width="195">Modelo<input required class="w3-input" type="text" name="modelo" style="width:195px;height:35px" ></td>
  ...
  <td colspan="3">Lugar de entrega
    <input class="w3-input" type="text" value="P" name="lugarentrega" style="width:300px;height:35px" required ></td>
   <td>&nbsp;</td>  
  <td>Cantidad
